...
class Template:
    ...
    def _set_attributes(self):
        ...
        self.pdf.add_font('InclusiveSans','','../fonts/InclusiveSans-Regular.ttf', uni=True)
        self.pdf.set_font('InclusiveSans', '', 10)
    ...
    def _generate_qr_code(self):
        ...
        file = self.student.name.split(' ')[0] + '_' + self.student.name.split(' ')[1] + '_qr_code.png'
        qrimage.save(file, 'PNG')
        return qrimage, file
    
    def _generate_header_and_box(self, template=None):
        self.pdf.set_font('InclusiveSans', '', 15)
        self.pdf.set_xy(5, 0)
        self.pdf.multi_cell(0, 10, "Id: " + str(self.student.id), 0, 0, 'C')

        self.pdf.set_font('InclusiveSans', '', 30)
        ...
        self.pdf.set_font('InclusiveSans', '', 24)
    ...
    def _generate_student_details(self):
        ...
        self.pdf.set_font('InclusiveSans', '', 18)
